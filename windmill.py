...
shorthand = item("wing.png",-1,90,40)
shorthand2 = item("wing.png",-1,90,80)
shorthand3 = item("wing.png",-1,90,40)
shorthand4 = item("wing.png",-1,90,40)
...
while 1:
    ...
    shorthand.drawrot(bg.axis,second)
    shorthand2.drawrot(bg.axis,second+90)
    shorthand3.drawrot(bg.axis,second+180)
    shorthand4.drawrot(bg.axis,second+270)
